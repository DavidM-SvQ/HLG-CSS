...
export function HotStreakTeams() {
  ...
  const [hotStreakMinPoints, setHotStreakMinPoints] = useUrlState<number | "">("hotStreakTeamMinPoints", 1);
  const [hotStreakMaxPoints, setHotStreakMaxPoints] = useUrlState<number | "">("hotStreakTeamMaxPoints", "");
  const [hotStreakLastNWeeks, setHotStreakLastNWeeks] = useUrlState<number>("hotStreakTeamLastNWeeks", 4);
  ...
  return (
    <div className={cn("bg-white border text-sm border-neutral-200 rounded-3xl shadow-sm flex flex-col mt-6 relative overflow-hidden", isExpanded ? "fixed inset-4 z-50 shadow-2xl" : "h-auto")} ref={chartRef}>
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-gradient-to-br from-indigo-100/50 via-purple-50/20 to-transparent rounded-full blur-[100px] -z-10 pointer-events-none" />
      ...
      <div className="px-6 py-5 border-b border-neutral-100 flex flex-col gap-4 bg-white/50 backdrop-blur-md">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 bg-white/80 p-3 rounded-xl border border-neutral-200 shadow-sm copy-button-ignore">
           <div className="flex flex-col gap-1 w-full sm:w-auto">
             ...
             <select
               className="text-sm border-neutral-300 bg-neutral-50 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 font-medium"
           ...
           <div className="flex flex-col gap-1 w-full sm:w-auto">
             ...
             <div className="flex items-center gap-2">
               <input
                 type="number"
                 placeholder="Min (1)"
                 className="text-sm border-neutral-300 bg-neutral-50 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 w-24 font-medium"
